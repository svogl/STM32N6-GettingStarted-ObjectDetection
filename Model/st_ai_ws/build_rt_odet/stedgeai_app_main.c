...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(odet) // Defines NN_Instance_odet and NN_Interface_odet with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[230400];
AI_ALIGNED(32)
...
AI_ALIGNED(32)
static ai_u8 weights_9[1201104];
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_odet);
  }
}
