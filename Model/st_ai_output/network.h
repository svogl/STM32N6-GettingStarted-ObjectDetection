...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "st_yolo_x_nano_480_1_0_0_25_3_st_int8"
...
#define LL_ATON_NETWORK_IN_1_SIZE_BYTES  (691200)

/************************** OUTPUTS *******************************************/
#define LL_ATON_NETWORK_OUT_NUM        (3)    // Total number of output buffers
// Output buffer 1 -- Transpose_782_out_0
#define LL_ATON_NETWORK_OUT_1_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (4050)
// Output buffer 2 -- Transpose_886_out_0
#define LL_ATON_NETWORK_OUT_2_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_2_SIZE_BYTES  (64800)
// Output buffer 3 -- Transpose_834_out_0
#define LL_ATON_NETWORK_OUT_3_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_3_SIZE_BYTES  (16200)
